                                        ...
                                        <form>
                                                ...
                                                <div class="row g-2">
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control" placeholder="First Name"
                                                            value="Ronald" readonly>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control" placeholder="Last Name"
                                                            value="Fuentebella" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <input type="email" class="form-control" placeholder="Email"
                                                    value="ronaldxdale@gmail.com" readonly>
                                            </div>

                                            <div class="mb-3">
                                                <input type="text" class="form-control" placeholder="Contact"
                                                    value="09352232051" readonly>
                                            </div>
                                                ...
                                                <div class="row g-2">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select class="form-select mb-3">
                                                            <option selected disabled>Agency Classification:</option>
                                                            <option value="new">Student</option>
                                                            <option value="returning">Gov. Employee</option>
                                                            <option value="returning">Researcher</option>
                                                            <option value="returning">Policy Maker</option>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="row g-2">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select class="form-select mb-3">
                                                            <option selected disabled>Type of Client</option>
                                                            <option value="new">Student</option>
                                                            <option value="returning">Gov. Employee</option>
                                                            <option value="returning">Researcher</option>
                                                            <option value="returning">Policy Maker</option>
