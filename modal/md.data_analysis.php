<div class="container-research my-4 p-3 border">
    ...
    <h3 class="header-research mb-3">
        Research Details
        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#researchDetails"
            aria-expanded="false" aria-controls="researchDetails">
            <i class="fas fa-chevron-down"></i>
        </button>
    </h3>

    <!-- Collapsible content -->
    <div class="collapse" id="researchDetails">
        <div class="row">
            <!-- Analysis Type -->
            <div class="col-md-6">
            ...
            <!-- Placeholder for potential another half column field -->
            <div class="col-md-6">
                <!-- Intentionally left empty for balance or future fields -->
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <textarea id="general-objective" name="general_objective" class="form-control" readonly
                        rows="3"></textarea>
                </div>
            </div>
            <!-- Specific Objectives -->
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <textarea id="specific-objective" name="specific_objective" class="form-control" readonly
                        rows="3"></textarea>
                </div>
            </div>
        </div>
