...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2024 at 06:22 PM
...
INSERT INTO `service_request` (`request_id`, `user_id`, `service_type`, `office_agency`, `agency_classification`, `client_type`, `status`, `selected_purposes`, `additional_purpose_details`, `request_date`, `scheduled_date`, `ongoing_date`, `cancelled_date`, `completed_date`, `inviteCode`, `scheduled_remarks`, `inprogress_remarks`, `completed_remarks`, `cancelled_remarks`) VALUES
(20, 1, 'data-analysis', 'TEST', 'Private Agency', 'Student', 'In Progress', 'Data Analysis', 'test', NULL, '2024-04-25 11:52:00', '2024-04-30', NULL, NULL, '288661', '', NULL, NULL, NULL),
(25, 1, 'capability-training', 'TEST', 'Goverment Organization', 'Faculty', 'In Progress', 'Technical Support', 'TEST', NULL, '2024-04-25 11:57:00', '2024-05-02', NULL, NULL, '9702bd', 'test', NULL, NULL, NULL),
(27, 1, 'technical-assistance', 'TEST', 'Private Agency', 'Student', 'Completed', 'Policy Development', 'test', NULL, '2024-04-30 10:51:00', '2024-05-02', NULL, NULL, '927fee', '', 'Your request has been successfully confirmed. To proceed to the next stage, ', 'test completed', NULL),
(28, 1, 'capability-training', 'TEST', 'Public Agency', 'Faculty', 'Approved', 'Policy Development', 'test', NULL, '2024-05-02 20:49:00', NULL, NULL, NULL, '756c17', 'TEST 5', NULL, NULL, NULL),
(29, 1, 'data-analysis', 'TEST W', 'Public Agency', 'Goverment Employee', 'Pending', 'Technical Support', 'TEST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(30, 1, 'data-analysis', 'TEST W', 'Public Agency', 'Goverment Employee', 'Approved', 'Technical Support', 'TEST', NULL, '2024-05-02 20:52:00', NULL, NULL, NULL, '5402f2', '', NULL, NULL, NULL),
(31, 2, 'data-analysis', 'Aetherio', 'Private Agency', 'Researcher', 'In Progress', 'Policy Development', '\"On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal ', NULL, NULL, '2024-05-02', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(5, 29, 'Statistical Tool', 'TEST', 'TEST', 'TEST3', NULL, NULL, NULL, 0),
(6, 30, 'Statistical Tool', 'TEST', 'TEST', 'TEST3', NULL, NULL, NULL, 0),
(7, 31, 'Statistical Tool', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', 't is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as oppo', 'web page editors now use Lorem Ipsum as their default model text, and a search for \'lorem ipsum\' will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).', NULL, NULL, NULL, 0);
...
INSERT INTO `sr_dataanalysis_files` (`da_file_id`, `request_id`, `filename`, `size`, `remarks`, `date_uploaded`) VALUES
(3, 31, 'AETHERIO-IT-SOLUTIONS-1ST-QUARTER.pdf', '239406', '0', '2024-05-02');
...
(9, 25, '1', '2024-04-29 22:11:00', 'face2face', 'test'),
(13, 27, '5', '2024-04-30 10:52:34', 'face2face', NULL),
(14, 20, '1', '2024-04-24 22:20:00', 'online', 'test'),
(15, 28, 'Initial Meeting', '2024-05-02 20:49:54', 'face2face', NULL),
(16, 30, 'Initial Meeting', '2024-05-02 20:52:24', 'face2face', NULL);
...
--
-- Dumping data for table `sr_tech_assistance`
--

INSERT INTO `sr_tech_assistance` (`ta_id`, `request_id`, `consultation_type`, `remarks`) VALUES
(2, 27, 'Face to Face', '');
...
(1, 25, '2024-04-26', '2024-04-26', 'TEST2', 'TEST3', 0),
(2, 28, '0000-00-00', '0000-00-00', 'TEST ', 'TEST 3', 0);
...
(1, 'Ron', NULL, 'Dale', NULL, 'admin@admin.com', '$2y$10$wWsVJA0Cfjr/FUxCDPUubeJGiVrqryvazLkFLYNvjn2qyq6qNGfLC', NULL, NULL, 'Administrator', NULL, '', NULL, NULL, NULL, NULL, NULL, '0', 1, '', NULL, NULL),
...
(8, 'RONALD DALE', 'Lyka', 'FUENTEBELLA', 2147483647, 'ronaldxdale@gmail.com', '$2y$10$m5b2xNSUu4H840HRgJMUoeRL/4ZmqOe9RNZYoSlQRuxuQogWXdEPa', 'student', 'no_schooling', 'Client', 0, '', '', 'Region IX (Zamboanga Peninzula)', 'Zamboanga City', 'Zamboanga Del Sur', 'Cawit', 'Client', 1, 'c8cfb88f4c', NULL, NULL);
...
--
ALTER TABLE `sr_dataanalysis`
  MODIFY `da_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `sr_dataanalysis_files`
--
ALTER TABLE `sr_dataanalysis_files`
  MODIFY `da_file_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `sr_meeting`
--
ALTER TABLE `sr_meeting`
  MODIFY `meet_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `sr_speaker`
--
ALTER TABLE `sr_speaker`
  MODIFY `sr_spk_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
