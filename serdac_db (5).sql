...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 04, 2024 at 05:19 PM
...
INSERT INTO `service_request` (`request_id`, `user_id`, `service_type`, `office_agency`, `agency_classification`, `client_type`, `purpose`, `status`, `request_date`, `scheduled_date`, `cancelled_date`, `completed_date`, `participants`, `inviteCode`) VALUES
(5, 8, 'capability-training', 'TEST', 'Private Agency', 'Student', 'test jaco', 'Approved', NULL, '2024-03-29', NULL, NULL, 4, '12345'),
(8, 1, 'capability-training', 'TEST', 'Goverment Organization', 'Faculty', '45454', 'Approved', NULL, '2024-04-20', NULL, NULL, 0, '97321e'),
(9, 2, 'technical-assistance', 'TEST', 'Private Agency', 'Student', 'test', 'Approved', NULL, '2024-04-13', NULL, NULL, 0, '3ecda3');
...
(1, 'Ron', NULL, 'Dale', NULL, 'admin@admin.com', '$2y$10$wWsVJA0Cfjr/FUxCDPUubeJGiVrqryvazLkFLYNvjn2qyq6qNGfLC', NULL, NULL, 'Administrator', NULL, NULL, NULL, NULL, NULL, NULL, '0', 1, ''),
(2, 'lyka', 'test', 'xandra', 123456789, 'user@user.com', '$2y$10$6VlT6GkjrF3VY7CaK5FGd.e/xUHSTLz1Yb0NR4raF2Cx2jl.uafD6', NULL, NULL, 'Client', NULL, NULL, 'Region IX (Zamboanga Peninzula)', 'Zamboanga City', 'Zamboanga Del Sur', 'Cawit', '0', 1, ''),
